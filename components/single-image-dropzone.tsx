...
const ERROR_MESSAGES = {
  fileTooLarge(maxSize: number) {
    return `File quá lớn. Kích cỡ giới hạn là ${formatFileSize(maxSize)}.`;
  },
  fileInvalidType() {
    return "Sai định dạng file.";
  },
  tooManyFiles(maxFiles: number) {
    return `Bạn chỉ có thể sử dụng ${maxFiles} file.`;
  },
  fileNotSupported() {
    return "File này không được hỗ trợ.";
  },
};
          ...
          {imageUrl ? (
            ...
            <div className="flex flex-col items-center justify-center text-xs text-gray-400">
              ...
              <div className="text-gray-400">
                Kéo và thả đến vùng này để tải ảnh lên
              </div>
            </div>
          )}
